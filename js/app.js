...
// Canva has no redistributable logo asset at all (their guidelines are
// stricter than Google/Meta's: "it's acceptable to use text for an action
// button, without the Canva logo") — so this is a plain, original "design"
// glyph in Canva's public palette, not a recreation of their trademarked
// mark, just to stop the row looking flat next to the others.
const CONNECTOR_BRAND_SVG = {
  ...
  facebook: '<svg class="connector-row-icon" width="20" height="20" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
    ...
    '</svg>',
  canva: '<svg class="connector-row-icon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
    '<circle cx="7.2" cy="7.6" r="5.6" fill="#8B3DFF" fill-opacity="0.9"/>' +
    '<circle cx="13.2" cy="7.6" r="5.6" fill="#00C4CC" fill-opacity="0.85"/>' +
    '<circle cx="10.2" cy="13" r="5.6" fill="#FF7262" fill-opacity="0.85"/>' +
    '</svg>',
};
